  ...
  module Helpers
    module SurveyorHelperMethods
      ...
      def mandatory_question_error(response_set_code, question)
        ...
        "<li class='question-error'> <a href='#{surveyor.edit_my_survey_path(response_set_code, section: question.survey_section_id)}'> #{question_text.truncate(100)} <span class='link-to'>#{link_to_svg_html}</span></a> </li>"
      end
      ...
      def link_to_svg_html
        %q(<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" height='15px' width='15px' xml:space="preserve"><g>
      <g>
